...
cors = {}
-- Correction: éviter Lighting comme parent protégé
        ...
        if v:IsA("Model") and v:FindFirstChild("Humanoid") then
            for _, c in pairs(v:GetChildren()) do
                if c.ClassName == "Part" and (c.Position - de).magnitude < Distan then
                    ...
                    if Noob ~= nil then
                        -- Exemple d'effet CamShake (à adapter selon ton script) :
...
function FindNearestTorso(Position, Distance, SinglePlayer)
    ...
    -- Si tu veux gérer le cas où SinglePlayer n'est pas fourni, tu peux ajouter un return nil ou false ici
    return false
end
...
elseif torvel2 and torvel==42 and hitfloor~=nil then
Anim="Run"
if attack==false then
