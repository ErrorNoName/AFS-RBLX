...
local SplashScreen = TS.import(script, script.Parent, "components", "SplashScreen").default
local BottomNavbar = TS.import(script, script.Parent, "components", "BottomNavbar").default
local sorbetTheme = TS.import(script, script.Parent, "themes", "themes").sorbetTheme
local UserInputService = game:GetService("UserInputService")
local TweenService = game:GetService("TweenService")
local AppContent = hooked(function()
	local _binding = useState(sorbetTheme)
	...
	local _binding_3 = useState(true)
	local showSplash = _binding_3[1]
	local setShowSplash = _binding_3[2]
	local _binding_4 = useState(false)
	local isLoading = _binding_4[1]
	local setIsLoadingState = _binding_4[2]
	local _binding_5 = useState({})
	local scripts = _binding_5[1]
	local setScripts = _binding_5[2]
	local _binding_6 = useState("scripts")
	local currentPage = _binding_6[1]
	local setCurrentPage = _binding_6[2]
	...
	local handleSearch = function(query)
		...
		local _exp = ScriptBloxService:searchScripts(query, 1, 24)
	...
	local handleSplashComplete = function()
		setShowSplash(false)
		setIsVisible(true)
	end
	-- Show splash screen
	if showSplash then
		return Roact.createElement(SplashScreen, {
			theme = currentTheme,
	...
	local _children = {
		Roact.createElement("Frame", {
			...
			Roact.createElement("UIGradient", {
				Color = ColorSequence.new({ ColorSequenceKeypoint.new(0, currentTheme.gradients.primary[1]), ColorSequenceKeypoint.new(1, currentTheme.gradients.primary[2]) }),
				Transparency = NumberSequence.new({ NumberSequenceKeypoint.new(0, 0.92), NumberSequenceKeypoint.new(1, 0.96) }),
				Rotation = 135,
			}),
		}),
	}
	...
	local _children_1 = {
		Roact.createElement("Frame", {
			...
			Roact.createElement("Frame", {
				...
				Roact.createElement("UIGradient", {
					Color = ColorSequence.new({ ColorSequenceKeypoint.new(0, currentTheme.colors.primary), ColorSequenceKeypoint.new(0.5, currentTheme.colors.primaryVariant), ColorSequenceKeypoint.new(1, currentTheme.colors.secondary) }),
					Rotation = 90,
				}),
			}),
	...
	local _children_2 = {
		Roact.createElement("UIGridLayout", {
			CellSize = UDim2.fromOffset(280, 200),
	...
	local _child = isLoading and (Roact.createFragment({
		LoadingCard = Roact.createElement("Frame", {
	...
	local _child_1 = not isLoading and (#scripts == 0 and (searchQuery ~= "" and (Roact.createFragment({
		NoResultsCard = Roact.createElement("Frame", {
			Size = UDim2.fromOffset(280, 200),
			BackgroundColor3 = currentTheme.colors.surface,
			BackgroundTransparency = 0.05,
			BorderSizePixel = 0,
	...
	_length_2 = #_children_2
	local _child_2 = not isLoading and (#scripts == 0 and (searchQuery == "" and (Roact.createFragment({
		WelcomeCard = Roact.createElement("Frame", {
			...
			Roact.createElement("TextLabel", {
				...
				Roact.createElement("UIGradient", {
					Color = ColorSequence.new({ ColorSequenceKeypoint.new(0, currentTheme.colors.primary), ColorSequenceKeypoint.new(1, currentTheme.colors.secondary) }),
					Rotation = 0,
				}),
			}),
			Roact.createElement("TextLabel", {
	...
	if _child_2 then
		_children_2[_length_2 + 1] = _child_2
	end
	_length_2 = #_children_2
	...
	_children_1[_length_1 + 2] = Roact.createElement(BottomNavbar, {
		theme = currentTheme,
		isVisible = isVisible,
	...
	return Roact.createFragment({
		SriBloxModern = Roact.createElement("ScreenGui", _attributes, _children),
	})
end)
return hooked(function()
	return Roact.createElement(AppContent)
end)
...
newModule("BottomNavbar", "ModuleScript", "SriBlox-Modern.components.BottomNavbar", "SriBlox-Modern.components", function () return setfenv(function() --Compiled with roblox-ts v1.3.3
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
local BottomNavbar = hooked(function(props)
	local _binding = props
	local theme = _binding.theme
	local isVisible = _binding.isVisible
	local currentPage = _binding.currentPage
	local onPageChange = _binding.onPageChange
	local _binding_1 = useState(nil)
	local hoveredTab = _binding_1[1]
	local setHoveredTab = _binding_1[2]
	local _binding_2 = useState(0)
	local indicatorPosition = _binding_2[1]
	local setIndicatorPosition = _binding_2[2]
	local _binding_3 = useState(100)
	local navbarYOffset = _binding_3[1]
	local setNavbarYOffset = _binding_3[2]
	-- Couleur du gradient en fonction de la tab active
	local getAccentColor = function()
		-- Déterminer la couleur selon la page active
		if currentPage == "scripts" then
			return theme.colors.primary
		end
		if currentPage == "favorites" then
	...
	useEffect(function()
		local targetY = if isVisible then -20 else 100
		local startY = navbarYOffset
		...
		connection = RunService.RenderStepped:Connect(function()
			...
			local eased = 1 - math.pow(1 - progress, 4) * math.cos(progress * math.pi * 2.5)
			local currentY = startY + distance * eased
	...
	useEffect(function()
		...
		local targetX = INDICATOR_POSITIONS[currentPage]
		-- DEBUG: Afficher les valeurs
		print("[BottomNavbar] Page: " .. (currentPage .. (", TargetX: " .. (tostring(targetX) .. "px (position absolue)"))))
		-- Animation smooth avec interpolation manuelle
		local startX = indicatorPosition
		...
		connection = RunService.RenderStepped:Connect(function()
			...
			local currentX = startX + distance * eased
	...
	local _attributes = {
		...
		Position = UDim2.new(0.5, 0, 1, navbarYOffset),
	...
	local _children = {
		...
		Roact.createElement("UIStroke", {
			...
			Roact.createElement("UIGradient", {
				Color = ColorSequence.new({ ColorSequenceKeypoint.new(0, theme.gradients.primary[1]), ColorSequenceKeypoint.new(0.5, theme.colors.primaryVariant), ColorSequenceKeypoint.new(1, theme.gradients.primary[2]) }),
				Rotation = 90,
			}),
		}),
		Roact.createElement("Frame", {
			...
			Roact.createElement("UIGradient", {
				Color = ColorSequence.new({ ColorSequenceKeypoint.new(0, theme.gradients.primary[1]), ColorSequenceKeypoint.new(1, theme.gradients.primary[2]) }),
				Transparency = NumberSequence.new({ NumberSequenceKeypoint.new(0, 0.85), NumberSequenceKeypoint.new(1, 1) }),
				Rotation = 0,
			}),
			Roact.createElement("UICorner", {
		...
		Roact.createElement("Frame", {
			...
			Position = UDim2.fromOffset(indicatorPosition, 52),
	...
	local _arg0 = function(tab)
		local isActive = currentPage == tab.id
		local isHovered = hoveredTab == tab.id
		local _attributes_1 = {
			Size = UDim2.fromOffset(100, 56),
			BackgroundColor3 = if isActive then getAccentColor() else theme.colors.surface,
			BackgroundTransparency = if isActive then 0.85 elseif isHovered then 0.9 else 1,
			BorderSizePixel = 0,
			Text = "",
			[Roact.Event.MouseButton1Click] = function()
				return onPageChange(tab.id)
			end,
			[Roact.Event.MouseEnter] = function()
				return setHoveredTab(tab.id)
			end,
			[Roact.Event.MouseLeave] = function()
				return setHoveredTab(nil)
			end,
		}
		local _children_1 = {
			Roact.createElement("UICorner", {
			...
			Roact.createElement("ImageLabel", {
				...
				BackgroundTransparency = 1,
				ImageColor3 = if isActive then getAccentColor() else Color3.fromRGB(255, 255, 255),
				ImageTransparency = if isActive then 0 elseif isHovered then 0.2 else 0.4,
			}),
			Roact.createElement("TextLabel", {
				...
				TextSize = 11,
				TextColor3 = if isActive then getAccentColor() else theme.colors.textSecondary,
				TextTransparency = if isActive then 0 elseif isHovered then 0.3 else 0.5,
			}),
		}
		local _length_1 = #_children_1
		local _child = isActive and (Roact.createElement("Frame", {
			Size = UDim2.fromScale(1, 1),
			BackgroundColor3 = getAccentColor(),
		...
		return Roact.createFragment({
			[tab.id] = Roact.createElement("TextButton", _attributes_1, _children_1),
		})
	end
	--▼ ReadonlyArray.map ▼
	local _newValue = table.create(#NAV_TABS)
	for _k, _v in ipairs(NAV_TABS) do
		_newValue[_k] = _arg0(_v, _k - 1, NAV_TABS)
	end
	--▲ ReadonlyArray.map ▲
	local _attributes_1 = {
		Size = UDim2.fromScale(1, 1),
	...
	_children[_length + 1] = Roact.createElement("Frame", _attributes_1, _children_1)
	return Roact.createFragment({
		BottomNavbar = Roact.createElement("Frame", _attributes, _children),
	})
end)
local default = BottomNavbar
return {
	default = default,
}
 end, newEnv("SriBlox-Modern.components.BottomNavbar"))() end)
...
local ScriptCard = hooked(function(props)
	...
	local setIsHovered = _binding[2]
	local _binding_1 = useState(false)
	local isPressed = _binding_1[1]
	local setIsPressed = _binding_1[2]
	local handleRun = function()
		local scriptUrl = "https://scriptblox.com/raw/" .. props.scriptData.slug
		...
		local success = { pcall(function()
			...
			local httpGet = gameAny.HttpGet
			if load ~= nil and httpGet ~= nil then
				load(httpGet(game, scriptUrl))()
			end
		end) }
		if success[1] then
			print("[SriBlox] ✓ Script executed successfully")
		else
			warn("[SriBlox] ✗ Failed to execute: " .. tostring(success[2]))
		end
	end
	local handleCopy = function()
		local scriptUrl = "https://scriptblox.com/raw/" .. props.scriptData.slug
		local env = getfenv(0)
		local clipboard = env.setclipboard
	...
	local cardScale = if isHovered and not isPressed then 1.05 else 1.0
	local shadowTransparency = if isHovered then 0.6 else 0.85
	local _attributes = {
	...
	local _children = {
		Roact.createElement("Frame", {
			Size = UDim2.new(cardScale, 12, cardScale, 12),
			...
			Roact.createElement("UIGradient", {
				Color = ColorSequence.new({ ColorSequenceKeypoint.new(0, props.theme.colors.primary), ColorSequenceKeypoint.new(1, props.theme.colors.accent) }),
				Rotation = 45,
			}),
		}),
	}
	local _length = #_children
	local _attributes_1 = {
		Size = UDim2.new(cardScale, 0, cardScale, 0),
		Position = UDim2.fromScale(0.5, 0.5),
		AnchorPoint = Vector2.new(0.5, 0.5),
	...
	local _children_1 = {
		...
		Roact.createElement("Frame", {
			...
			Roact.createElement("UIGradient", {
				Color = ColorSequence.new({ ColorSequenceKeypoint.new(0, props.theme.colors.surface), ColorSequenceKeypoint.new(1, props.theme.colors.surfaceVariant) }),
				Rotation = 135,
			}),
		}),
	}
	local _length_1 = #_children_1
	local _child = isHovered and (Roact.createElement("Frame", {
		Size = UDim2.fromScale(1, 1),
	...
	_children_1[_length_1 + 1] = Roact.createElement("UIStroke", {
		Color = if isHovered then props.theme.colors.primary else props.theme.colors.border,
		Thickness = if isHovered then 2 else 1,
		Transparency = if isHovered then 0.3 else 0.7,
	}, {
		Roact.createElement("UIGradient", {
			Color = ColorSequence.new({ ColorSequenceKeypoint.new(0, props.theme.colors.primary), ColorSequenceKeypoint.new(0.5, props.theme.colors.accent), ColorSequenceKeypoint.new(1, props.theme.colors.primary) }),
			Rotation = 45,
		}),
	})
	local _attributes_2 = {
	...
	local _result = props.scriptData.game
	if _result ~= nil then
		_result = _result.name
	end
	local _condition = _result
	if not (_condition ~= "" and _condition) then
		_condition = "Universal"
	end
	_attributes_4.Text = _condition
	_attributes_4.TextColor3 = props.theme.colors.primary
	_attributes_4.Font = Enum.Font.GothamBold
	_attributes_4.TextSize = 11
	_attributes_4.TextTruncate = Enum.TextTruncate.AtEnd
	_children_3[_length_3 + 1] = Roact.createElement("TextLabel", _attributes_4)
	_children_2[_length_2 + 1] = Roact.createElement("Frame", _attributes_3, _children_3)
	_children_2[_length_2 + 2] = Roact.createElement("TextLabel", {
	...
	local _condition_1 = props.scriptData.views
	if not (_condition_1 ~= 0 and (_condition_1 == _condition_1 and _condition_1)) then
		_condition_1 = 0
	end
	_attributes_6.Text = "👁️ " .. tostring(_condition_1)
	_attributes_6.TextColor3 = props.theme.colors.textSecondary
	_attributes_6.Font = Enum.Font.Gotham
	_attributes_6.TextSize = 12
	_attributes_6.TextXAlignment = Enum.TextXAlignment.Left
	...
	local _condition_2 = (props.scriptData).likeCount
	if not (_condition_2 ~= 0 and (_condition_2 == _condition_2 and (_condition_2 ~= "" and _condition_2))) then
		_condition_2 = 0
	end
	_attributes_7.Text = "⭐ " .. tostring(_condition_2)
	_attributes_7.TextColor3 = props.theme.colors.textSecondary
	_attributes_7.Font = Enum.Font.Gotham
	_attributes_7.TextSize = 12
	_attributes_7.TextXAlignment = Enum.TextXAlignment.Left
	_children_4[_length_4 + 2] = Roact.createElement("TextLabel", _attributes_7)
	_children_2[_length_2 + 3] = Roact.createElement("Frame", _attributes_5, _children_4)
	_children_2[_length_2 + 4] = Roact.createElement("Frame", {
		...
		Roact.createElement("TextButton", {
			...
			Font = Enum.Font.GothamBold,
			TextSize = 14,
			[Roact.Event.MouseButton1Click] = handleRun,
		}, {
			Roact.createElement("UICorner", {
				CornerRadius = UDim.new(0, 8),
			}),
		...
		Roact.createElement("TextButton", {
			...
			Font = Enum.Font.GothamBold,
			TextSize = 16,
			[Roact.Event.MouseButton1Click] = handleCopy,
		}, {
			Roact.createElement("UICorner", {
				CornerRadius = UDim.new(0, 8),
			}),
	...
	_children_1[_length_1 + 2] = Roact.createElement("Frame", _attributes_2, _children_2)
	_children_1[_length_1 + 3] = Roact.createElement("TextButton", {
		Size = UDim2.fromScale(1, 1),
		BackgroundTransparency = 1,
		Text = "",
		ZIndex = 10,
...
newModule("Sidebar", "ModuleScript", "SriBlox-Modern.components.Sidebar", "SriBlox-Modern.components", function () return setfenv(function() --Compiled with roblox-ts v1.3.3
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
local useState = _roact_hooked.useState
local NavButton = hooked(function(props)
	local _binding = useState(false)
	local isHovered = _binding[1]
	local setIsHovered = _binding[2]
	return Roact.createElement("TextButton", {
		...
		BackgroundColor3 = if props.isActive then props.theme.colors.primary elseif isHovered then props.theme.colors.surfaceVariant else Color3.fromRGB(0, 0, 0),
		BackgroundTransparency = if props.isActive then 0.7 elseif isHovered then 0.9 else 1,
		BorderSizePixel = 0,
		Text = "",
		[Roact.Event.MouseEnter] = function()
			return setIsHovered(true)
		...
		Roact.createElement("TextLabel", {
			...
			BackgroundTransparency = 1,
			Text = props.icon,
			TextColor3 = if props.isActive then props.theme.colors.primary else props.theme.colors.text,
			Font = Enum.Font.GothamBold,
			TextSize = 24,
		}),
		Roact.createElement("TextLabel", {
			...
			Text = props.label,
			TextColor3 = if props.isActive then props.theme.colors.primary else props.theme.colors.text,
			Font = if props.isActive then Enum.Font.GothamBold else Enum.Font.Gotham,
			TextSize = 15,
			TextXAlignment = Enum.TextXAlignment.Left,
		}),
	})
end)
local Sidebar = hooked(function(props)
	local _binding = useState("Scripts")
	local currentPage = _binding[1]
	local setCurrentPage = _binding[2]
	return Roact.createElement("Frame", {
		Size = UDim2.new(0, 240, 1, 0),
		Position = UDim2.new(0, if props.isOpen then 0 else -240, 0, 0),
		...
		Roact.createElement("ScrollingFrame", {
			...
			Roact.createElement(NavButton, {
				icon = "🔍",
				label = "Scripts",
				isActive = currentPage == "Scripts",
				onClick = function()
					return setCurrentPage("Scripts")
				end,
				theme = props.theme,
			}),
			Roact.createElement(NavButton, {
				...
				onClick = function()
					return setCurrentPage("Favorites")
				end,
				theme = props.theme,
			}),
			Roact.createElement(NavButton, {
		...
		Roact.createElement("Frame", {
			...
			Roact.createElement("UIGradient", {
				Color = ColorSequence.new({ ColorSequenceKeypoint.new(0, props.theme.colors.primary), ColorSequenceKeypoint.new(0.5, props.theme.colors.accent), ColorSequenceKeypoint.new(1, props.theme.colors.primary) }),
				Rotation = 90,
				Transparency = NumberSequence.new({ NumberSequenceKeypoint.new(0, 0.9), NumberSequenceKeypoint.new(0.5, 0.3), NumberSequenceKeypoint.new(1, 0.9) }),
			}),
		}),
	})
end)
return {
 ...
 end, newEnv("SriBlox-Modern.components.Sidebar"))() end)

newModule("SplashScreen", "ModuleScript", "SriBlox-Modern.components.SplashScreen", "SriBlox-Modern.components", function () return setfenv(function() --Compiled with roblox-ts v1.3.3
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
local SplashScreen = hooked(function(props)
	local _binding = props
	local theme = _binding.theme
	local onComplete = _binding.onComplete
	local _binding_1 = useState(0)
	local progress = _binding_1[1]
	local setProgress = _binding_1[2]
	local _binding_2 = useState(true)
	local isVisible = _binding_2[1]
	local setIsVisible = _binding_2[2]
	useEffect(function()
		...
		local connection = game:GetService("RunService").RenderStepped:Connect(function()
			local elapsed = tick() - startTime
			local currentProgress = math.min(elapsed / duration, 1)
	...
	local getProgressColor = function()
	...
	return Roact.createFragment({
		SplashScreen = Roact.createElement("Frame", {
			Size = UDim2.fromScale(1, 1),
			...
			Roact.createElement("Frame", {
				...
				Roact.createElement("TextLabel", {
					...
					BackgroundTransparency = 1,
					Text = "Loading... " .. (tostring(math.floor(progress * 100)) .. "%"),
...
local default = SplashScreen
return {
	default = default,
}
 end, newEnv("SriBlox-Modern.components.SplashScreen"))() end)

newModule("TopBar", "ModuleScript", "SriBlox-Modern.components.TopBar", "SriBlox-Modern.components", function () return setfenv(function() --Compiled with roblox-ts v1.3.3
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
local TopBar = hooked(function(props)
	return Roact.createElement("Frame", {
		...
		Roact.createElement("TextButton", {
			...
			Font = Enum.Font.GothamBold,
			TextSize = 24,
			[Roact.Event.MouseButton1Click] = props.onMenuToggle,
		}, {
			Roact.createElement("UICorner", {
				CornerRadius = UDim.new(0, 12),
			}),
...
return {
 ...
 end, newEnv("SriBlox-Modern.components.TopBar"))() end)
...
local TS = require(script.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local App = TS.import(script, script.Parent, "App")
...
local sorbetTheme = {
	...
	colors = {
		...
		primary = Color3.fromRGB(198, 66, 142),
		primaryVariant = Color3.fromRGB(154, 63, 229),
		secondary = Color3.fromRGB(72, 79, 215),
		accent = Color3.fromRGB(154, 63, 229),
	...
	gradients = {
		primary = { Color3.fromRGB(198, 66, 142), Color3.fromRGB(72, 79, 215) },
		card = { Color3.fromRGB(36, 36, 36), Color3.fromRGB(42, 42, 46) },
		accent = { Color3.fromRGB(198, 66, 142), Color3.fromRGB(154, 63, 229) },
	},
	blur = {
		enabled = true,
		intensity = 28,
...
local defaultTheme = sorbetTheme
return {
	sorbetTheme = sorbetTheme,
	darkTheme = darkTheme,
...
newInstance("compiler-types", "Folder", "SriBlox-Modern.include.node_modules.@rbxts.compiler-types", "SriBlox-Modern.include.node_modules.@rbxts")

newModule("package", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.compiler-types.package", "SriBlox-Modern.include.node_modules.@rbxts.compiler-types", function () return setfenv(function() return {
	author = "roblox-ts",
	description = "",
	devDependencies = {
		["@rbxts/types"] = "^1.0.459",
...
} end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.compiler-types.package"))() end)

newInstance("types", "Folder", "SriBlox-Modern.include.node_modules.@rbxts.compiler-types.types", "SriBlox-Modern.include.node_modules.@rbxts.compiler-types")

newInstance("flipper", "Folder", "SriBlox-Modern.include.node_modules.@rbxts.flipper", "SriBlox-Modern.include.node_modules.@rbxts")

newModule("package", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.flipper.package", "SriBlox-Modern.include.node_modules.@rbxts.flipper", function () return setfenv(function() return {
	author = "Reselim",
	...
	version = "2.0.1",
} end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.flipper.package"))() end)

newModule("src", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.flipper.src", "SriBlox-Modern.include.node_modules.@rbxts.flipper", function () return setfenv(function() local Flipper = {
...
return Flipper end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.flipper.src"))() end)

newModule("BaseMotor", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.flipper.src.BaseMotor", "SriBlox-Modern.include.node_modules.@rbxts.flipper.src", function () return setfenv(function() local RunService = game:GetService("RunService")
...
return BaseMotor
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.flipper.src.BaseMotor"))() end)

newModule("GroupMotor", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.flipper.src.GroupMotor", "SriBlox-Modern.include.node_modules.@rbxts.flipper.src", function () return setfenv(function() local BaseMotor = require(script.Parent.BaseMotor)
...
return GroupMotor
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.flipper.src.GroupMotor"))() end)

newModule("Instant", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.flipper.src.Instant", "SriBlox-Modern.include.node_modules.@rbxts.flipper.src", function () return setfenv(function() local Instant = {}
...
return Instant end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.flipper.src.Instant"))() end)

newModule("Linear", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.flipper.src.Linear", "SriBlox-Modern.include.node_modules.@rbxts.flipper.src", function () return setfenv(function() local Linear = {}
...
return Linear end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.flipper.src.Linear"))() end)

newModule("Signal", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.flipper.src.Signal", "SriBlox-Modern.include.node_modules.@rbxts.flipper.src", function () return setfenv(function() local Connection = {}
...
return Signal end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.flipper.src.Signal"))() end)

newModule("SingleMotor", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.flipper.src.SingleMotor", "SriBlox-Modern.include.node_modules.@rbxts.flipper.src", function () return setfenv(function() local BaseMotor = require(script.Parent.BaseMotor)
...
return SingleMotor
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.flipper.src.SingleMotor"))() end)

newModule("Spring", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.flipper.src.Spring", "SriBlox-Modern.include.node_modules.@rbxts.flipper.src", function () return setfenv(function() local VELOCITY_THRESHOLD = 0.001
...
return Spring end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.flipper.src.Spring"))() end)

newModule("isMotor", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.flipper.src.isMotor", "SriBlox-Modern.include.node_modules.@rbxts.flipper.src", function () return setfenv(function() local function isMotor(value)
...
return isMotor end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.flipper.src.isMotor"))() end)

newInstance("typings", "Folder", "SriBlox-Modern.include.node_modules.@rbxts.flipper.typings", "SriBlox-Modern.include.node_modules.@rbxts.flipper")

newInstance("roact", "Folder", "SriBlox-Modern.include.node_modules.@rbxts.roact", "SriBlox-Modern.include.node_modules.@rbxts")

newModule("package", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.package", "SriBlox-Modern.include.node_modules.@rbxts.roact", function () return setfenv(function() return {
	author = "",
	contributors = {{
	...
	version = "1.4.0-ts.2",
} end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.package"))() end)

newModule("src", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", "SriBlox-Modern.include.node_modules.@rbxts.roact", function () return setfenv(function() --[[
...
return Roact end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src"))() end)

newModule("Binding", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.Binding", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local createSignal = require(script.Parent.createSignal)
...
return BindingInternalApi end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.Binding"))() end)

newModule("Component", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.Component", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local assign = require(script.Parent.assign)
...
return Component end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.Component"))() end)

newModule("ComponentLifecyclePhase", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.ComponentLifecyclePhase", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local Symbol = require(script.Parent.Symbol)
...
return ComponentLifecyclePhase end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.ComponentLifecyclePhase"))() end)

newModule("Config", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.Config", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return Config end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.Config"))() end)

newModule("ElementKind", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.ElementKind", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return ElementKind end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.ElementKind"))() end)

newModule("ElementUtils", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.ElementUtils", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local Type = require(script.Parent.Type)
local Symbol = require(script.Parent.Symbol)
...
return ElementUtils end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.ElementUtils"))() end)

newModule("GlobalConfig", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.GlobalConfig", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
	Exposes a single instance of a configuration as Roact's GlobalConfig.
]]

local Config = require(script.Parent.Config)

return Config.new() end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.GlobalConfig"))() end)

newModule("Logging", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.Logging", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return Logging end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.Logging"))() end)

newModule("None", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.None", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local Symbol = require(script.Parent.Symbol)

-- Marker used to specify that the value is nothing, because nil cannot be
-- stored in tables.
local None = Symbol.named("None")

return None end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.None"))() end)

newModule("NoopRenderer", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.NoopRenderer", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return NoopRenderer end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.NoopRenderer"))() end)

newModule("Portal", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.Portal", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local Symbol = require(script.Parent.Symbol)

local Portal = Symbol.named("Portal")

return Portal end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.Portal"))() end)

newInstance("PropMarkers", "Folder", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.PropMarkers", "SriBlox-Modern.include.node_modules.@rbxts.roact.src")

newModule("Change", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.PropMarkers.Change", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.PropMarkers", function () return setfenv(function() --[[
...
return Change
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.PropMarkers.Change"))() end)

newModule("Children", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.PropMarkers.Children", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.PropMarkers", function () return setfenv(function() local Symbol = require(script.Parent.Parent.Symbol)

local Children = Symbol.named("Children")

return Children end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.PropMarkers.Children"))() end)

newModule("Event", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.PropMarkers.Event", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.PropMarkers", function () return setfenv(function() --[[
...
return Event
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.PropMarkers.Event"))() end)

newModule("Ref", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.PropMarkers.Ref", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.PropMarkers", function () return setfenv(function() local Symbol = require(script.Parent.Parent.Symbol)

local Ref = Symbol.named("Ref")

return Ref end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.PropMarkers.Ref"))() end)

newModule("PureComponent", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.PureComponent", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return PureComponent end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.PureComponent"))() end)

newModule("RobloxRenderer", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.RobloxRenderer", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return RobloxRenderer
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.RobloxRenderer"))() end)

newModule("SingleEventManager", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.SingleEventManager", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return SingleEventManager end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.SingleEventManager"))() end)

newModule("Symbol", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.Symbol", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return Symbol end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.Symbol"))() end)

newModule("Type", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.Type", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return Type end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.Type"))() end)

newModule("assertDeepEqual", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.assertDeepEqual", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return assertDeepEqual end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.assertDeepEqual"))() end)

newModule("assign", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.assign", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local None = require(script.Parent.None)
...
return assign end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.assign"))() end)

newModule("createContext", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.createContext", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local Symbol = require(script.Parent.Symbol)
...
return createContext
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.createContext"))() end)

newModule("createElement", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.createElement", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local Children = require(script.Parent.PropMarkers.Children)
local ElementKind = require(script.Parent.ElementKind)
local Logging = require(script.Parent.Logging)
local Type = require(script.Parent.Type)
...
return createElement end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.createElement"))() end)

newModule("createFragment", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.createFragment", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local ElementKind = require(script.Parent.ElementKind)
local Type = require(script.Parent.Type)
...
return createFragment end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.createFragment"))() end)

newModule("createReconciler", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.createReconciler", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local Type = require(script.Parent.Type)
local ElementKind = require(script.Parent.ElementKind)
...
return createReconciler
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.createReconciler"))() end)

newModule("createReconcilerCompat", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.createReconcilerCompat", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return createReconcilerCompat end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.createReconcilerCompat"))() end)

newModule("createRef", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.createRef", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return createRef end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.createRef"))() end)

newModule("createSignal", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.createSignal", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return createSignal
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.createSignal"))() end)

newModule("createSpy", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.createSpy", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return createSpy end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.createSpy"))() end)

newModule("forwardRef", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.forwardRef", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local assign = require(script.Parent.assign)
...
return forwardRef end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.forwardRef"))() end)

newModule("getDefaultInstanceProperty", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.getDefaultInstanceProperty", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return getDefaultInstanceProperty end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.getDefaultInstanceProperty"))() end)

newModule("internalAssert", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.internalAssert", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local function internalAssert(condition, message)
	if not condition then
		error(message .. " (This is probably a bug in Roact!)", 3)
	end
end

return internalAssert end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.internalAssert"))() end)

newModule("invalidSetStateMessages", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.invalidSetStateMessages", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return invalidSetStateMessages end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.invalidSetStateMessages"))() end)

newModule("oneChild", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.oneChild", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return oneChild end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.oneChild"))() end)

newModule("strict", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact.src.strict", "SriBlox-Modern.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local function strict(t, name)
...
return strict end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact.src.strict"))() end)

newInstance("roact-hooked", "Folder", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked", "SriBlox-Modern.include.node_modules.@rbxts")

newModule("out", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
local exports = {}
...
exports.pure = pure
return exports
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out"))() end)

newModule("hooks", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
local exports = {}
...
return exports
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks"))() end)

newModule("use-binding", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks.use-binding", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
...
return {
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks.use-binding"))() end)

newModule("use-callback", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks.use-callback", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
...
return {
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks.use-callback"))() end)

newModule("use-context", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks.use-context", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
--[[
	*
...
return {
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks.use-context"))() end)

newModule("use-effect", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks.use-effect", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
...
return {
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks.use-effect"))() end)

newModule("use-memo", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks.use-memo", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
local areDepsEqual = TS.import(script, script.Parent.Parent, "utils", "are-deps-equal").areDepsEqual
local memoizedHook = TS.import(script, script.Parent.Parent, "memoized-hook").memoizedHook
--[[
...
return {
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks.use-memo"))() end)

newModule("use-mutable", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks.use-mutable", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
local memoizedHook = TS.import(script, script.Parent.Parent, "memoized-hook").memoizedHook
...
return {
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks.use-mutable"))() end)

newModule("use-reducer", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks.use-reducer", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
local _memoized_hook = TS.import(script, script.Parent.Parent, "memoized-hook")
local memoizedHook = _memoized_hook.memoizedHook
local resolveCurrentComponent = _memoized_hook.resolveCurrentComponent
...
return {
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks.use-reducer"))() end)

newModule("use-ref", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks.use-ref", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
...
return {
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks.use-ref"))() end)

newModule("use-state", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks.use-state", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
...
return {
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.hooks.use-state"))() end)

newModule("memoized-hook", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.memoized-hook", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
...
return {
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.memoized-hook"))() end)

newModule("types", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.types", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
-- Roact
-- Reducers
-- Utility types
-- Hooks
return nil
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.types"))() end)

newInstance("utils", "Folder", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.utils", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out")

newModule("are-deps-equal", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.utils.are-deps-equal", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.utils", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
return {
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.utils.are-deps-equal"))() end)

newModule("resolve", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.utils.resolve", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.utils", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
return {
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.utils.resolve"))() end)

newModule("with-hooks", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.with-hooks", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
local exports = {}
local _with_hooks = TS.import(script, script, "with-hooks")
...
return exports
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.with-hooks"))() end)

newModule("component-with-hooks", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.with-hooks.component-with-hooks", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.with-hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
local _memoized_hook = TS.import(script, script.Parent.Parent, "memoized-hook")
...
return {
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.with-hooks.component-with-hooks"))() end)

newModule("with-hooks", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.with-hooks.with-hooks", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.with-hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
...
return {
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.out.with-hooks.with-hooks"))() end)

newModule("package", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.package", "SriBlox-Modern.include.node_modules.@rbxts.roact-hooked", function () return setfenv(function() return {
	author = "littensy",
	bugs = {
	...
	version = "1.2.7",
} end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-hooked.package"))() end)

newInstance("roact-rodux-hooked", "Folder", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked", "SriBlox-Modern.include.node_modules.@rbxts")

newModule("package", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.package", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked", function () return setfenv(function() return {
	author = "littensy",
	bugs = {
	...
	version = "1.1.3",
} end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.package"))() end)

newModule("src", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked", function () return setfenv(function() local RoactRoduxContext = require(script.components.Context)
...
return {
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src"))() end)

newInstance("components", "Folder", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.components", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src")

newModule("Context", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.components.Context", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.components", function () return setfenv(function() local Roact = require(script.Parent.Parent.vendor.Roact)

local RoactRoduxContext = Roact.createContext()

return RoactRoduxContext
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.components.Context"))() end)

newModule("StoreProvider", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.components.StoreProvider", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.components", function () return setfenv(function() local Roact = require(script.Parent.Parent.vendor.Roact)
...
return StoreProvider
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.components.StoreProvider"))() end)

newInstance("hooks", "Folder", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.hooks", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src")

newModule("useDispatch", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.hooks.useDispatch", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.hooks", function () return setfenv(function() local Hooks = require(script.Parent.Parent.vendor.RoactHooked)
...
return useDispatch
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.hooks.useDispatch"))() end)

newModule("useSelector", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.hooks.useSelector", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.hooks", function () return setfenv(function() -- https://github.com/reduxjs/react-redux/blob/7.x/src/hooks/useSelector.js
...
return useSelector
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.hooks.useSelector"))() end)

newModule("useStore", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.hooks.useStore", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.hooks", function () return setfenv(function() local Hooks = require(script.Parent.Parent.vendor.RoactHooked)
...
return useStore
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.hooks.useStore"))() end)

newInstance("utils", "Folder", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.utils", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src")

newModule("shallowEqual", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.utils.shallowEqual", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.utils", function () return setfenv(function() local function shallowEqual(left, right)
	if left == right then
		return true
	end
...
return shallowEqual
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.utils.shallowEqual"))() end)

newInstance("vendor", "Folder", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.vendor", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src")

newModule("Roact", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.vendor.Roact", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.vendor", function () return setfenv(function() local modules = script:FindFirstAncestor("node_modules")
...
elseif script.Parent.Parent.Parent:FindFirstChild("Roact") then
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.vendor.Roact"))() end)

newModule("RoactHooked", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.vendor.RoactHooked", "SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.vendor", function () return setfenv(function() local modules = script:FindFirstAncestor("node_modules")
...
elseif script.Parent.Parent.Parent:FindFirstChild("roact-hooked") then
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.roact-rodux-hooked.src.vendor.RoactHooked"))() end)

newInstance("rodux", "Folder", "SriBlox-Modern.include.node_modules.@rbxts.rodux", "SriBlox-Modern.include.node_modules.@rbxts")

newModule("package", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.rodux.package", "SriBlox-Modern.include.node_modules.@rbxts.rodux", function () return setfenv(function() return {
	author = "",
	contributors = {{
		name = "Jonathan Holmes",
		url = "https://github.com/Vorlias",
	...
	typings = "src/index.d.ts",
	version = "3.0.0-ts.3",
} end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.rodux.package"))() end)

newModule("src", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src", "SriBlox-Modern.include.node_modules.@rbxts.rodux", function () return setfenv(function() local Store = require(script.Store)
...
return {
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.rodux.src"))() end)

newModule("NoYield", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src.NoYield", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src", function () return setfenv(function() --!nocheck
...
return NoYield
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.rodux.src.NoYield"))() end)

newModule("Signal", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src.Signal", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src", function () return setfenv(function() --[[
...
return Signal end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.rodux.src.Signal"))() end)

newModule("Store", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src.Store", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src", function () return setfenv(function() local RunService = game:GetService("RunService")
...
return Store
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.rodux.src.Store"))() end)

newModule("combineReducers", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src.combineReducers", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src", function () return setfenv(function() --[[
...
return combineReducers
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.rodux.src.combineReducers"))() end)

newModule("createReducer", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src.createReducer", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src", function () return setfenv(function() return function(initialState, handlers)
	return function(state, action)
		if state == nil then
			state = initialState
		end
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.rodux.src.createReducer"))() end)

newModule("loggerMiddleware", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src.loggerMiddleware", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src", function () return setfenv(function() -- We want to be able to override outputFunction in tests, so the shape of this
...
return loggerMiddleware
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.rodux.src.loggerMiddleware"))() end)

newModule("makeActionCreator", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src.makeActionCreator", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src", function () return setfenv(function() --[[
...
return makeActionCreator
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.rodux.src.makeActionCreator"))() end)

newModule("prettyPrint", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src.prettyPrint", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src", function () return setfenv(function() local indent = "    "
...
return prettyPrint end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.rodux.src.prettyPrint"))() end)

newModule("thunkMiddleware", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src.thunkMiddleware", "SriBlox-Modern.include.node_modules.@rbxts.rodux.src", function () return setfenv(function() --[[
...
return thunkMiddleware
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.rodux.src.thunkMiddleware"))() end)

newModule("services", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.services", "SriBlox-Modern.include.node_modules.@rbxts", function () return setfenv(function() return setmetatable({}, {
 ...
 end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.services"))() end)

newModule("package", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.services.package", "SriBlox-Modern.include.node_modules.@rbxts.services", function () return setfenv(function() return {
	author = "",
	description = "",
	devDependencies = {
	...
	typings = "index.d.ts",
	version = "1.6.0",
} end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.services.package"))() end)

newInstance("types", "Folder", "SriBlox-Modern.include.node_modules.@rbxts.types", "SriBlox-Modern.include.node_modules.@rbxts")

newInstance("include", "Folder", "SriBlox-Modern.include.node_modules.@rbxts.types.include", "SriBlox-Modern.include.node_modules.@rbxts.types")

newInstance("generated", "Folder", "SriBlox-Modern.include.node_modules.@rbxts.types.include.generated", "SriBlox-Modern.include.node_modules.@rbxts.types.include")

newModule("package", "ModuleScript", "SriBlox-Modern.include.node_modules.@rbxts.types.package", "SriBlox-Modern.include.node_modules.@rbxts.types", function () return setfenv(function() return {
	author = "roblox-ts",
	bugs = {
	...
	version = "1.0.890",
} end, newEnv("SriBlox-Modern.include.node_modules.@rbxts.types.package"))() end)
